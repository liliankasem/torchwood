...
describe('EventTests', () => {
    describe('Read events from the chain', () => {
        it('should read the existing events on a block', () => {
            ...
            const test_string = '[{ \
                ...
                "args": { "sender": "0x87f0a3ce6db9a48e599de3ef67cc56ef865abde2" \
            }}]';

            const test_payload = JSON.parse(test_string);
            const expected = JSON.parse('[{"event": "DownloadRequestEvent","args": {"sender": "0x87f0a3ce6db9a48e599de3ef67cc56ef865abde2"}}]');
            ...
            const events = Web3Adapter.GetEvents("123", "abi", 0);
            events.then(function (result: any) {
